import { SignupInput } from "@samkitsoni/packages_medium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-6">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="eg: John Doe" onChange={(e) => {
                        setpostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} ></LabelledInput> : null}
                    <LabelledInput label="Email" placeholder="eg: xyz@abc.com" onChange={(e) => {
                        setpostInputs({
                            ...postInputs,
                            email: e.target.value
                        })
                    }} ></LabelledInput>
                    <LabelledInput label="Password" type={"password"} placeholder="Min 6 letters ..." onChange={(e) => {
                        setpostInputs({
                            ...postInputs,
...
function LabelledInput({label , placeholder, onChange, type}: LabelledInput) {
    return <div>
        <label className=" mt-2 block mb-2 text-sm font-semibold text-black">{label}</label>
